...
def add_to_bag(request, item_id):
    ...
    if item_id in list(shopping_bag.keys()):
        ...
        messages.success(request, f'{quantity} more {product.name} was added to your bag') # noqa
    else:
        shopping_bag[item_id] = quantity
...
def adjust_bag(request, item_id):
    ...
    if quantity > 0:
        shopping_bag[item_id] = quantity
        messages.success(request, f'{product.name} quantity: {quantity} in your bag') # noqa
    else:
