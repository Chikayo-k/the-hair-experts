            ...
            for item_id, item_data in shopping_bag.items():
                try:
                    ...
                    messages.error(request, (
                        "Issue on our database. Please reach out our member staff" # noqa
                    ))
                    order.delete()
...
def checkout_success(request, order_number):
    ...
    messages.success(request, f'The order has been successfully completed!! Order Number: {order_number}. We will shortly send a confirmation email to {order.email}. Thank you !! ') # noqa
